...
| Variable | Description | Default |
|---|---|---|
| `MEMTOMEM_INDEXING__MEMORY_DIRS` | Directories auto-indexed on start (JSON list) | `["~/.claude/projects", "~/.gemini", "~/.codex/memories"]` |
| `MEMTOMEM_INDEXING__SUPPORTED_EXTENSIONS` | File extensions to index (JSON list) | `[".md", ".py", ".js", ".ts", ".json", ".yaml", ".toml"]` |
