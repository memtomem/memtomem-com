...
<Tabs syncKey="mcp-client">
  ...
  <TabItem label="Cursor">
    Cursor 의 MCP 설정에서 `memtomem-server` 와 `memtomem-stm` 을 stdio 서버로 등록합니다. 자세한 절차는 [MCP 클라이언트 설정](https://github.com/memtomem/memtomem/blob/main/docs/guides/mcp-client-setup.md)을 참고하세요.
  </TabItem>
  <TabItem label="Windsurf">
    Windsurf 의 MCP 설정에서 `memtomem-server` 와 `memtomem-stm` 을 stdio 서버로 등록합니다. 자세한 절차는 [MCP 클라이언트 설정](https://github.com/memtomem/memtomem/blob/main/docs/guides/mcp-client-setup.md)을 참고하세요.
  </TabItem>
  <TabItem label="Claude Desktop">
    Claude Desktop 의 MCP 설정에서 `memtomem-server` 와 `memtomem-stm` 을 stdio 서버로 등록합니다. 자세한 절차는 [MCP 클라이언트 설정](https://github.com/memtomem/memtomem/blob/main/docs/guides/mcp-client-setup.md)을 참고하세요.
  </TabItem>
</Tabs>
