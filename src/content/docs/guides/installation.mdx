...
| `mm tags` | Manage memory tags (list, rename, delete, merge) |
...
| `mms stats` | Show proxy performance and token compression statistics |
| `mms surfacing` | Scope or toggle proactive surfacing per upstream |
