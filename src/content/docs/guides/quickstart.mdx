...
<Tabs syncKey="mcp-client">
  ...
  <TabItem label="Cursor">
    Register `memtomem-server` and `memtomem-stm` as stdio MCP servers in Cursor's MCP settings. See [MCP Client Setup](https://github.com/memtomem/memtomem/blob/main/docs/guides/mcp-client-setup.md) for details.
  </TabItem>
  <TabItem label="Windsurf">
    Register `memtomem-server` and `memtomem-stm` as stdio MCP servers in Windsurf's MCP settings. See [MCP Client Setup](https://github.com/memtomem/memtomem/blob/main/docs/guides/mcp-client-setup.md) for details.
  </TabItem>
  <TabItem label="Claude Desktop">
    Register `memtomem-server` and `memtomem-stm` as stdio MCP servers in Claude Desktop's MCP settings. See [MCP Client Setup](https://github.com/memtomem/memtomem/blob/main/docs/guides/mcp-client-setup.md) for details.
  </TabItem>
</Tabs>
